#ifndef PROTOCOLS_MAL3PCBINPROTOCOL_H_
 ...
 */
template<class T>
class Mal3PCBinProtocol : public ProtocolBase<T> {
    typedef Replicated<T> super;
    typedef Mal3PCBinProtocol This;
...
public:
    ...
    Mal3PCBinProtocol(Player& P);
    Mal3PCBinProtocol(Player& P, array<PRNG, 2>& prngs);
    ~Mal3PCBinProtocol() {
        ...
        cout << "End Mal3pc Bin at " << std::chrono::high_resolution_clock::now().time_since_epoch().count() << endl;
    }
...
#endif /* PROTOCOLS_Mal3PCBinProtocol_H_ */